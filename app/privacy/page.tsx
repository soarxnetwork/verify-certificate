  ...
  return (
    <div className="mt-40 w-full mb-20">
      ...
      <p className="pl-7 pr-7 sm:py-10 sm:px-32 text-[1.2rem]">
        ...
        online platform www.soarx.me (“Website”). This Privacy Policy and
        ...
        or complaint. By visiting www.soarx.me, you agree to be bound by the
        ...
        this Website. We ensure to review this Privacy Policy from time to time
        so that it is updated. If you are just a visitor, then kindly note that
        this Policy is subject to change at any time without notice. To ensure
        that you are aware of any changes in the Policy, please review this
      ...
      <p className="pl-7 pr-7 sm:py-10 sm:px-32 text-[1.2rem]">
        ...
        certain information in order to increase security, analyse developments
        and administer the Website with a view to help us in making customer
        experience better. We utilise this information to analyse traffic
        patterns on our Website so as to make it more beneficial for our
        visitors. We collect your Personal Data only when you register with us,
        when you are interested in obtaining information regarding our products
        and services, when you participate in activities on our Website or
        contact us. We will only collect your Personal Information if there is a
        proper and valid reason for doing so, for instance : to comply with our
        regulatory and legal obligations; for the performance of our contract
        with you or to take the required steps at your request before entering
        into a legal contract; for our legitimate interests or where you have
        given consent. A legitimate interest is when we have a valid commercial
        or business reason to use your information. In certain cases, we may
        also have a legal obligation to collect personal data from you or may
        otherwise need the personal information to protect your interests or
        those of another individual (for instance, in order to prevent payment
        fraud or confirm your identity). Our primary objective in collecting
        your Personal Information is to provide you a safe, effective, seamless
        and customized experience. This allows us to provide online courses,
        study material and tutorials that most likely meet your needs and to
        customize our Website to make your experience easier, better and safer.
        The information we gather from you helps us personalize and continually
        improve customer experience at our Website. We do not voluntarily make
        this information available to any third parties, nor do we use it for
        any other objective, except as set out herein. In order to register on
      ...
      <p className="pl-7 pr-7 md:px-32 text-[1.2rem]">
        ...
        business purposes of the kind set out in this Policy. We will use your
        personal information to provide, analyse and improve our offerings, to
        provide you with a customized experience on our Website, to contact you
        about your account and our services, to render customer service, to
        provide you with personalized marketing and to any fraudulent or illegal
        activities. In addition to this, we use your personal information to
        figure out your general geographic location, provide localized course
        content and classes, recommendations, determine your ISP, and help us
        quickly and efficiently respond to queries and enforcing our terms and
        communicate with you concerning our service (for example by email, push
        notifications, text messaging ,and online messaging channels), so that
        we can provide you details about latest features and content available
      ...
      <p className="pl-7 pr-7 md:py-10 md:px-32 text-[1.2rem]">
        ...
        community spaces or sharing your personal information with others on
        SoarX. You should be aware that any personal information you submit
      ...
      <p className="md:py-10 md:px-32 pl-7 pr-7 text-[1.2rem]">
        ...
        personalize and optimize our service, to process payment transactions,
        to provide customer service, to analyze and enhance data, and to conduct
        consumer surveys. In the process of providing such services, these
        Service Providers may have access to your personal or other information.
      ...
      <p className="md:py-10 pl-7 pr-7 md:px-32 text-[1.2rem]">
        ...
        misuse of data. We have standard SSL certification which basically helps
        us create a secure connection between our server and user to render any
        information or action. Some of the protective measures we use are
        firewalls and data encryption, physical access controls to our data
        centres and information access authorization controls. Only user
        passwords are encrypted in 64-bit encryption and stored because
      ...
      <p className="pl-7 pr-7 md:py-10 md:px-32 text-[1.2rem]">
        ...
        accepted the terms of the Policy on your first use of the Web Site
